...
export const PUBLIC_KEY = new PublicKey(
  "5ULzT7wyU4TqB62mVgp7ccUarnB1n9bS9cHjZJ4UT21n"
);

export const ATA_ADDRESS = new PublicKey(
  "G4YhHE2z7HzFdoQQyqz3hT7tshXYDGmYS42ckZdY7UDm"
);

export const TOKEN_MINT_ADDRESS = new PublicKey(
  "CmRBzPTTyL4wR4phM5ibhYRtEPudRvdqK9dEBcswd3Pm"
);
...
export const HELIUS_DATA = {
  ...
  description:
    "FUv5jWF7VsYMBDup3cLPdVond4AVbA7kSE1GFRuYcK1N transferred 0.1 SOL to CPkZyUB27wz923zkJVaUfxufCbGcXyuM9HEc43Z6wGvf.",
  events: {},
  fee: 15000,
  ...
  instructions: [
    ...
    {
      accounts: [
        "FUv5jWF7VsYMBDup3cLPdVond4AVbA7kSE1GFRuYcK1N",
        "CPkZyUB27wz923zkJVaUfxufCbGcXyuM9HEc43Z6wGvf",
      ],
  ...
  signature:
    "QGAXXgZfA3PR1LCV3UdZtKkknkx1fqGfotuKG13agt4xSm5R5QAMWZGmDWDSKBLHFRPgRwNstF6QHGxpFYT7bZQ",
  slot: 338295968,
...
export const HELIUS_DATA_BURN = {
  accountData: [
    ...
    {
      account: "GRURykEQMekWogEF8gHoKEiHtVuafu4aS1UMkwWYAvi4",
      nativeBalanceChange: 0,
      tokenBalanceChanges: [],
    },
    {
  ...
  instructions: [
    ...
    {
      accounts: [
        "CoDdFra63FaL2Z6wjGAkrHaMVXSQCU43iPctZaGo6W8g",
        "GRURykEQMekWogEF8gHoKEiHtVuafu4aS1UMkwWYAvi4",
        "8mSftUkCcRVL2ht2JvNRXMNo87Xk6tSMnokZvkT6ZfLH",
        "FUv5jWF7VsYMBDup3cLPdVond4AVbA7kSE1GFRuYcK1N",
        "FUv5jWF7VsYMBDup3cLPdVond4AVbA7kSE1GFRuYcK1N",
      ],
      data: "g7Ez8CcPA4BjN",
  ...
  nativeTransfers: [],
  signature:
    "4FLShqPwCjLhyBcp9me6S1eQ4U6KYZmH5RPTUWtdBnCgtRFTtYGWvnnLBB4vvoNhe2Jk9MHciksv3iVnBBzTbd4z",
  slot: 338384800,
  source: "UNKNOWN",
  timestamp: 1730986226,
  tokenTransfers: [],
  transactionError: null,
  type: "UNKNOWN",
};
